...
func (c *V1InternalMerchantController) Block(w http.ResponseWriter, r *http.Request) {
	ctx, segment := otelTracer.Start(r.Context(), "port/http/controller/v1/internalController/merchantForbiddenUsecase/Block")
	defer segment.End()
