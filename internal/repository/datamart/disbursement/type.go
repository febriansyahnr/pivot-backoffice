...
var otelTracer = otel.Tracer("DisbursementDatamartRepository")

func New(cfg config.BigQueryConfig, db bigquery.IBigQueryService, log logger.ILogger) datamart.IDatamartDisbursementMetrics {
	return &repository{
