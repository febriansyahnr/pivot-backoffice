...
type UpdateRequest struct {
	...
	Payment *PaymentUpdate `json:"payment,omitempty"` // Payment info
	Account *AccountUpdate `json:"account,omitempty"` // Account info

	AdjAmt *decimal.Decimal `json:"adj_amt,omitempty"`

	// Full payment context for providers that need it (e.g. Sokratech).
	FullContext *CheckRequest `json:"-"`
}
