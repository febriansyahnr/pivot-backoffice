...
func (r *EncryptCardRequest) ToCreditcardRequestModel() *creditcardCoreProcessorModel.EncryptCardRequest {
...
func GetUnifiedEncryptedCardResponse(card *creditcardCoreProcessorModel.EncryptedCardResponse) *EncryptedCardResponse {
