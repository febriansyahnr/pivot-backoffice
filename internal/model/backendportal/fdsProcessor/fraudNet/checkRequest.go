...
type MarketplaceCheckRequest struct {
	Account     AccountMarketplaceCheck          `json:"account,omitempty"`
	Customer    CustomerMarketplaceCheck         `json:"customer,omitempty"`
	Payment     PaymentMarketplaceCheck          `json:"payment,omitempty"`
	Partner     PartnerMarketplaceCheck          `json:"partner,omitempty"`
	Transaction TransactionMarketplaceCheck      `json:"transaction,omitempty"`
	Device      DeviceMarketplaceCheck           `json:"device,omitempty"`
	IB          IntermediaryBankMarketplaceCheck `json:"ib,omitempty"`
	CP          CounterpartyBankMarketplaceCheck `json:"cp,omitempty"`
	Mid         *MidMarketplaceCheck             `json:"mid,omitempty"`
}

type MidMarketplaceCheck struct {
	Number        *string `json:"number,omitempty"`
	Type          *string `json:"type,omitempty"`
	AcquiringName *string `json:"acquiring_name,omitempty"`
}

type AccountMarketplaceCheck struct {
	...
	IncOn            *time.Time       `json:"inc_on,omitempty"`             // Date the business account was incorporated
...
type CustomerMarketplaceCheck struct {
...
type PaymentMarketplaceCheck struct {
	...
	BilledAmt         *string          `json:"billed_amt,omitempty"`
...
type PartnerMarketplaceCheck struct {
	Address1    *string `json:"address1,omitempty"` // Building number and street address
	Address2    *string `json:"address2,omitempty"` // Apartment/suite/unit number
	City        *string `json:"city,omitempty"`     // Address city
	Company     *string `json:"company,omitempty"`  // Company name, for business addresses
...
type TransactionMarketplaceCheck struct {
	...
	Status            *string          `json:"status,omitempty"` // Allowed values: new, hold, queued, approved, cancelled, fulfilled, returned
	Event             *string          `json:"event,omitempty"`
...
type DeviceMarketplaceCheck struct {
	...
	IPType              *string `json:"ip_type,omitempty"` // Allowed: v4, v6
...
type IntermediaryBankMarketplaceCheck struct {
	ID         *string `json:"id,omitempty"`
...
type CounterpartyBankMarketplaceCheck struct {
	ID             *string `json:"id,omitempty"`
